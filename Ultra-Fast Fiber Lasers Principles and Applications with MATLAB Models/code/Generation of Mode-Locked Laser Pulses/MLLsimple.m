...
Kmag = 3;   % this factor is proportional to the refinement (interval between points) of the transformed frequency data;
...
Tfil = (exp(-log(2)*(2/f3dB*((freq-shift*delta_freq)*Kmag)).^n)+exp(-log(2)*(2/f3dB*((freq+shift*delta_freq)*Kmag)).^n))/2;	% multiply Kmag to scale back
